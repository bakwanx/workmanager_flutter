...
const simplePeriodic1MinuteTask = "be.tramckrijte.workmanagerExample.simplePeriodic1MinuteTask";
  ...
  Workmanager().executeTask((task, inputData) async {
    switch (task) {
      ...
      case simplePeriodicTask:
        ...
        break;
      case simplePeriodic1MinuteTask:
        print("$simplePeriodic1MinuteTask was executed");
        break;
